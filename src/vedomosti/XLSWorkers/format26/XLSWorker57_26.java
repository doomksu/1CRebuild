 ...
 * @author kneretin
 */
public class XLSWorker57_26 extends XLSWorker57 {
    
    private final int FIRST_ROW_NUM = 17;
    
    public XLSWorker57_26(Workbook _wb, OrganizationsGroup _banks, HashMap<String, String> _params) {
    ...
    protected void writeOrganization(Organization org, Sheet cloneFromSheet, String newSheetName) {
        ...
        getCellFromReference("C11").setCellValue(orgParams.get("OrgDostName"));
        getCellFromReference("C12").setCellValue(orgParams.get("OrgDostINN"));
